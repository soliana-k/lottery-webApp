              ...
              <div className="card-inner">
                <div className="card-content">
                  ...
                  <p className="card-description">
                    Manage and update prize details here. You can add new prizes
                    or modify existing ones.
                  </p>
                  <Link to="/prizes" className="card-link">
                    Go to Prizes Management
                  </Link>
                </div>
              </div>
            </div>
              ...
              <div className="card-inner">
                <div className="card-content">
                  ...
                  <BorderColorIcon className="card_icon" />
                    ...
                    Number Management</h5>
                  <p className="card-description">
                    View and manage selected and remaining numbers. Update
                    number allocations as needed.
                  </p>
                  <Link to="/numbers" className="card-link">
            ...
            <div className="card">
              <div className="card-inner">
                <div className="card-content">
                  ...
                  <p className="card-description">
                    Update and manage website content. This includes text,
